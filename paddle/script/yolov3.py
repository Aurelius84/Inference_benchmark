...
class YOLOv3(object):
    ...
    def build_input(self):
        ...
        self.gtlabel = fluid.data(
            name="gtlabel", shape=[-1, cfg.max_box_num], dtype='int32')
        self.gtscore = fluid.data(
            name="gtscore", shape=[-1, cfg.max_box_num], dtype='float32')
